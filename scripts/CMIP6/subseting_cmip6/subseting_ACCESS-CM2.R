      ...
      for (d in 1:length(dates)){
        ...
        if (d == 1){
          ...
          for (p in 1:length(guide$lon)){
            ...
            pixel <- array[X,Y, 1:18262] # change every model
            
            for (r in 1:12){ # 16 for pr
        ...
        if (d == 2){
          ...
          for (p in 1:length(guide$lon)){
            ...
            pixel <- array[X,Y, 1:5479] # change every model
            
            for (r in 1:4){ # 16 for pr
      ...
      for (d in 1:length(dates)){
        ...
        if (d == 2){
          ...
          for (p in 1:length(guide$lon)){
            ...
            pixel <- array[X,Y, 1:13148] # change every model
            
            for (r in 1:8){ # 16 for pr
