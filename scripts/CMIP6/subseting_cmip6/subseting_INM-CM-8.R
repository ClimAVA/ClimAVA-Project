    ...
    if(ssp == "historical") {
      ...
      for (d in 1:length(dates)){
        ...
        if (d == 1){
          ...
          pixels = rep(-999999, 7300)
          p=1
          for (p in 1:length(guide$lon)){
            
            Y <- ((guide[p,2] + 90)/lat_res)+1 # Y is the pixel position in the netcdf. takes the coordinates of the pixel divide by resolution and sums 90 becouse it is in the north hemisphere 
            X <- (guide[p,3]/ lon_res)+1
            
            pixel <- array[X,Y, 10951:18250] # change every model
        ...
        if (d == 2){
          ...
          for (p in 1:length(guide$lon)){
            ...
            pixel <- array[X,Y, 1:5475] # change every model
      ...
      for (d in 1:length(dates)){
        ...
        if (d == 1){
          ...
          for (p in 1:length(guide$lon)){
            ...
            pixel <- array[X,Y, 1:18250] # change every model
        ...
        if (d == 2){
          ...
          for (p in 1:length(guide$lon)){
            ...
            pixel <- array[X,Y, 1:13140] # change every model
